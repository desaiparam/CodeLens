...
service_account = json.loads(os.getenv("FIREBASE_CREDENTIAL_JSON"))

if not firebase_admin._apps:
    cred = credentials.Certificate(service_account)
    firebase_admin.initialize_app(cred, {
        'databaseURL': "https://solana-staking-0510.firebaseio.com"
    })
db = firestore.client()
...
COHERE_API_KEYS = os.getenv("COHERE_API_KEYS", "").split(",")
key_cycle = cycle(COHERE_API_KEYS)

# GitHub API Token (use environment variable or replace directly)
os.environ['GITHUB_TOKEN_1'] = os.getenv("GITHUB_TOKEN_1")
os.environ['GITHUB_TOKEN_2'] = os.getenv("GITHUB_TOKEN_2")
